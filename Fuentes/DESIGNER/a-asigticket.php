...
{
	$tic->__SET('Opcion', $_POST['Opcion']);
	$tic->__SET('IdTicket', $_POST['IdTicket']);
	$tic->__SET('IdCliente', $_POST['IdCliente']);
  $tic->__SET('IdProblema', $_POST['IdProblema']);
  $tic->__SET('Asunto', $_POST['Asunto']);
  $tic->__SET('Descripcion', $_POST['Descripcion']);
  $tic->__SET('FechaCrea', $_POST['FechaCrea']);

	$ticDAO->Registrar($tic);
	header('Location: a-sigticket.php');
}
...
<input class="formb" type="submit" value="Guardar" name="guardar">
</form>
</div>
