<?php
 				...
 				<div class="row">
 					<section>
 						<header>
 							...
 							<br><h3><a href="t-bproceso.html">Volver</a></h3>
 						</header>
 						<br>
 						</section>
 ...
 <input class="form" type="text" id="lname" name="lastname" placeholder="21/09/2018">

 <input class="formb" type="submit" value="Reportar ticket">
 </form>
 </div>
